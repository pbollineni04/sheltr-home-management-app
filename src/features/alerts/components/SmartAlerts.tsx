            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600">
                  {onlineSensors}/{sensorData.length}
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-600">{alerts.filter((a) => a.autoTask).length}</p>
              </div>
                    ...
                    <div key={sensor.id} className="p-4 rounded-lg border bg-white">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-lg flex items-center justify-center ${getStatusColor(sensor.status)}`}
                          >
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className={`text-sm ${getBatteryColor(sensor.battery)}`}>{sensor.battery}%</span>
                        </div>
                      </div>

                      <p className="text-xs text-gray-500">Last update: {sensor.lastUpdate}</p>
                    </div>
                  )
                })}
              </div>
                    ...
                    {alert.autoTask && (
                      <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-blue-700">Auto-created task: {alert.taskCreated}</span>
                        </div>
                  ...
                  <div key={insight.id} className="p-4 rounded-lg border bg-gradient-to-r from-blue-50 to-green-50">
                    ...
                    <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-700">Recommendation: {insight.recommendation}</span>
                      </div>
                  ...
                  return (
                    <div key={device.id} className="flex items-center justify-between p-4 rounded-lg border">
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-10 h-10 rounded-lg flex items-center justify-center ${getStatusColor(device.status)}`}
                        >
                          <IconComponent className="w-5 h-5" />
                        </div>
                        <div>
