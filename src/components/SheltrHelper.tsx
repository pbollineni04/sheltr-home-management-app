...
const SheltrHelper = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      content: "Hi! I'm your Sheltr Helper. I can answer any homeownership questions, give maintenance tips, and offer second opinions on your projects. What would you like to know?",
      sender: "assistant",
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const response = {
        ...
        content: "Thanks for your question! Based on your home profile, here's my recommendation... [This would be a real AI response in the actual app]",
        sender: "assistant",
        timestamp: new Date()
      };
